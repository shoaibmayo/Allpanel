...
@section('content')
    <main id="main" class="main">
        <div class="pagetitle">
            <h5 class="fw-bold">Add Game Page</h5>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.game.list') }}">Game List</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.game.add') }}">Game Add</a></li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.game.create') }}" method="post" enctype="multipart/form-data"  class="row g-3">
                            @csrf
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" id="round_id" name="round_id" 
                                    class="form-control "  placeholder="Video Round" value="{{ old('video_round') }}">
                                @error('round_id')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" id="video_description"  rows="3" name="video_description"
                                    placeholder="Video Description">{{ old('video_description') }}</textarea>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" id="game_descriptionGame_description" rows="3"  name="game_description"
                                    placeholder="Game Description">{{ old('game_description') }}</textarea>
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $.each(data, function(index, childCategory) {
                                $('#child-category').append('<option value="' + childCategory.id + '">' + childCategory.name + '</option>');
                            });
                        }
                    });
                } else {
