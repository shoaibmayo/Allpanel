...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h5 class="fw-bold">SubCategory List Page</h5>
            <nav>
                <ol class="breadcrumb">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <a href="{{ route('admin.subcategory.add') }}" class="bn float-end mt-3">Add New
                                        SubCategory 
                                    </a>
                                    @endif
                                </div>
                                        ...
                                        @foreach ($subcategories as $value)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('admin.subcategory.edit',$value->id) }}"
                                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                                        data-bs-custom-class="custom-tooltip" data-bs-title="Edit SubCategory">
...
<script>
    ...
    deleteModal.addEventListener('show.bs.modal', function (event) {
        ...
        form.action = 'sub-category/delete/' + userId
    });
