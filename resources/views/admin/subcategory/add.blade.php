...
@section('content')
    <main id="main" class="main">
        <div class="pagetitle">
            <h5 class="fw-bold">Add Subcategory Page</h5>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.subcategory.list') }}">Subcategory List</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.subcategory.add') }}">Subcategory Add</a></li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.subcategory.create') }}" method="post" id="categoryFrom" name="categoryFrom"  class="row g-3">
                            @csrf
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" name="category" id="category" >
                                    ...
                                    @foreach ($categories as $value )
                                        <option {{ (old('category') == $value->id ) ? 'selected' : '' }}  value="{{ $value->id }}">{{ $value->name }}</option>
                                    @endforeach
                                </select>
                                @error('category')
                                    <div class="text-danger">{{ $message }}</div>
