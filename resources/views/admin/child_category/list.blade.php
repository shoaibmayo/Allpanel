...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h5 class="fw-bold">Child Category List Page</h5>
            <nav>
                <ol class="breadcrumb">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <h5 class="card-title">All ChildCategory</h5>
                                </div>
                                <div class="col-lg-6">
                                    @if (!empty($PermissionAdd))
                                    <a href="{{ route('admin.childcategory.add') }}"  class="bn float-end mt-3">Add New
                                        Child Category
                                     </a>
                                     @endif
                                </div>
                                        ...
                                        @foreach ($childcategories as $value)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('admin.childcategory.edit',$value->id) }}"
                                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                                        data-bs-custom-class="custom-tooltip" data-bs-title="Edit Child Category">
                                                        <i class="bi bi-pencil-square text-success fw-bolder m-2" ></i></a>
                                                    @endif
                                                    @if (!empty($PermissionDelete))
                                                    <span data-bs-toggle="tooltip" data-bs-placement="top"
                                                    data-bs-custom-class="custom-tooltip"
                                                    data-bs-title="Delete Child Category">
...
<script>
    ...
    deleteModal.addEventListener('show.bs.modal', function (event) {
        ...
        form.action = 'child-category/delete/' + userId
    });
     // tooltip code here
     $(function() {
